...
We compared the performance of Cloudbreak for detecting deletions and insertions to a selection of popular tools: the RP method Breakdancer \autocite{Chen:2009p3}, GASVPro, an RP method that integrates RD signals and ambiguous mappings to increase sensitivity and specificity \autocite{Sindi:2012kk}, the SR method Pindel \autocite{Ye:2009p2}, and the hybrid RP-SR method DELLY \autocite{Rausch:2012he}. All of these methods detect deletions; in addition Breakdancer and Pindel are capable of detecting insertions. In each case we use default parameters and attempt to follow the recommend pipelines for alignment for each tool (See Methods for details).
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\textwidth]{CHR2SIM_INS_ROC.pdf}
...
\begin{tabular}{rrrrrr}
 ...
 Total Number & 199 &  83 & 79 &  21 & 21\\ 
  \hline
  Cloudbreak  & \textbf{  49} (  25)  &    5 (   3) &     2 (   1) & 0 (0) & 0 (0) \\ 
  Breakdancer &   23 (  10)  & \textbf{  14} (\textbf{  11}) &     2 (   1) & 0 (0) & 0 (0) \\ 
  Pindel      &   47 (\textbf{  30})  &    7 (   4) &  \textbf{  10} (\textbf{  10}) & \textbf{   3} (\textbf{   3}) & \textbf{   9} (\textbf{   9})\\ 
   \hline
\end{tabular}
\end{center}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\textwidth]{NA18507_INS_ROC.pdf}
...
Total Number & & & 536 & 114 & 45 & 1 \\
  \hline
Cloudbreak & 0.000626 & \textbf{0.412} & \textbf{ 265} (\textbf{  95})  &   20 (   8) &     2 (   1) & 0 (0) \\ 
Breakdancer & \textbf{0.0267} & 0.181 &   97 (  16)  & \textbf{  27} (\textbf{  13}) &     2 (   1) & 0 (0) \\  
  Pindel & 0.00793 & 0.239 &  144 (  29)  &   14 (  12) &  \textbf{   7} (\textbf{   7}) & \textbf{   1} (\textbf{   1})  \\ 
   \hline
\end{tabular}
\end{center}
...
\hline
 ...
 Total Number & 133 & 270 & 341 & 355 \\ 
  \hline
  Cloudbreak  &   16 (   4) &   40 (  25) & \textbf{ 146} (\textbf{  44}) & \textbf{ 141} (\textbf{  60}) \\ 
  Breakdancer &   17 (   9) &   22 (  13) &   82 (  17) &   44 (  13) \\
  Pindel      & \textbf{  26} (\textbf{  20}) & \textbf{  50} (\textbf{  36}) &   84 (  29) &   82 (  20) \\ 
   \hline
\end{tabular}
\end{center}
