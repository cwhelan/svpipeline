...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{/users/cwhelan/Documents/gene_rearrange/insert_size_mixtures.pdf}
...
\begin{tabular}{rrr|rrrrr}
 ...
 Total Number &          &           & 224 &  84 & 82 &  31 & 26\\ 
  \hline
  Cloudbreak    &  \textbf{0.532} & \textbf{0.66} & \textbf{146} (  6)  &  58 (\textbf{  4}) &   62 (  1) &  14 (  1) &  15 (0) \\ 
...
An ROC curve for insertion prediction performance is shown in Figure \ref{chr2InsertionsRoc}. The number of insertions identified by each algorithm at maximum sensitivity, again broken down by size, is shown in Table \ref{chr2InsertionPreds}. Cloudbreak shows excellent precision, although recall is low for all four approaches. Cloudbreak again identifies the most small variants. Pindel is the only tool which can identify large insertions, as insertions larger than the library insert size do not produce mapping signatures detectable by read-pair mapping.
...
\hline
 & SV Types &  Single CPU & Parallel & Proc. &  Single CPU & Parallel & Proc.  \\ 
  ...
  DELLY & D         &  1,964 & NA          & NA      & 14,475  & 37,390 & 84 \\
