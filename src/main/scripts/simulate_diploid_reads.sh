...
dwgsim -e 0.02-0.02 -E 0.02-0.02 -d 100 -s 30 -1 100 -2 100 -C 10 -r 0.0010 -R 0 -H -P hap1 $HAP1_REF $HAP1_REF
dwgsim -e 0.02-0.02 -E 0.02-0.02 -d 100 -s 30 -1 100 -2 100 -C 10 -r 0.0010 -R 0 -H -P hap2 $HAP2_REF $HAP2_REF
